        ...
        <div class="form-cetak">
            ...
            <div class="section" style="line-height:0.7;">
                ...
                <table class="detail-table" style="margin-left: 14px; width: 95%;">
                    <tr>
                        <td width="171">No. Rumah</td><td width="10">:</td><td width="200">{{ $detail->no_rumah_tinggal ?? '-' }}</td>
                ...
                <table class="detail-table" style="margin-left: 14px; width: 95%;">
                    <tr>
                        <td width="171">No. Rumah</td><td width="10">:</td><td width="200">{{ $detail->no_rumah_ktp ?? '-' }}</td>
                        <td width="171">RT/RW</td><td width="10">:</td><td>{{ $detail->rt_rw_ktp ?? '-' }}</td>
                    </tr>
                    <tr>
                ...
                <table class="detail-table">
                    <tr>
                        <td width="185">7. No. KTP/Passport</td><td width="10">:</td><td width="350">{{ $detail->no_ktp ?? '-' }}</td>
            ...
            <div class="section">
                ...
                <div style="margin-top: 10px;">
                    ...
                    ( {{ ($detail->punya_saudara_di_perusahaan ?? false) ? '✓' : 'ㅤ' }} ) ya
                    ( {{ !($detail->punya_saudara_di_perusahaan ?? false) ? '✓' : 'ㅤ' }} ) tidak

                    @if($detail->punya_saudara_di_perusahaan ?? false)
                        @php
                            $saudara = is_array($detail->saudara_di_perusahaan) ? $detail->saudara_di_perusahaan : json_decode($detail->saudara_di_perusahaan ?? '{}', true);
                        @endphp
                        @if(!empty($saudara) && isset($saudara[0]['nama']))
                        <div style="border-bottom: 1px dotted #999; margin-top: 5px; padding: 3px;">: 
                            Nama lengkapnya <u>{{ $saudara[0]['nama'] ?? '' }}</u>, 
                            bekerja di unit kerja <u>{{ $saudara[0]['jabatan'] ?? '' }}</u>, 
                            hubungan dengan pelamar yaitu sebagai <u>{{ $saudara[0]['hubungan'] ?? '' }}</u>, 
                            sudah kenal selama <u>{{ $saudara[0]['lama_kenal'] ?? '' }}</u>
                        </div>
                        @else
                        <div style="border-bottom: 1px dotted #999; margin-top: 5px; padding: 3px; color: #999;">
                            Data saudara/kenalan tidak tersedia
                        </div>
                        @endif
                    @endif
                </div>
            ...
            <div class="section">
                ...
                @if(($detail->punya_pasangan ?? false) && !empty($dataPasangan))
                    ...
                    <table class="detail-table" style="line-height: 0.7;">
                        <tr>
                            <td width="185">a. Nama Lengkap</td>
                            <td width="10">:</td>
                            <td>{{ $dataPasangan['nama_lengkap'] ?? '-' }}</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                {{ $dataPasangan['tempat_lahir'] ?? '-' }},
                                {{ isset($dataPasangan['tanggal_lahir']) ? \Carbon\Carbon::parse($dataPasangan['tanggal_lahir'])->format('d/m/Y') : '-' }}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                {{ isset($dataPasangan['tanggal_menikah']) ? \Carbon\Carbon::parse($dataPasangan['tanggal_menikah'])->format('d/m/Y') : '-' }}
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>d. Agama</td>
                            <td>:</td>
                            <td>{{ $dataPasangan['agama'] ?? '-' }}</td>
                        </tr>

                        <tr>
                            <td>e. Alamat Tinggal</td>
                            <td>:</td>
                            <td>{{ $dataPasangan['alamat'] ?? '-' }}</td>
                        </tr>
                    </table>
                    ...
                    <table class="detail-table" style="margin-left: 14px; width: 95%;">
                        <tr>
                            <td width="100">No. Rumah</td><td width="10">:</td><td width="150">{{ $dataPasangan['no_rumah'] ?? '-' }}</td>
                ...
                <table class="detail-table">
                    <tr>
                        <td width="185">f. Pendidikan</td>
                        <td width="10">:</td>
                        <td>{{ $dataPasangan['pendidikan'] ?? '-' }}</td>
                    </tr>

                    <tr>
                        <td width="185">g. Pekerjaan</td>
                        <td width="10">:</td>
                        <td width="350">{{ $dataPasangan['pekerjaan'] ?? '-' }}</td>

                        <td width="120">Jabatan</td>
                        <td width="10">:</td>
                        <td>{{ $dataPasangan['jabatan'] ?? '-' }}</td>
                    </tr>
                </table>
                @else
            ...
            <div class="sub-section-title" style="margin-top: 10px;">5. Orang Terdekat yang Dapat Dihubungi dalam Keadaan Darurat (yang tidak tinggal serumah)</div>
                ...
                <div style="line-height: 0.7;">
                    <table class="detail-table" style="line-height: 0.7;">
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                {{ $kontakDarurat['tempat_lahir'] ?? '-' }},
                                {{ isset($kontakDarurat['tanggal_lahir']) ? \Carbon\Carbon::parse($kontakDarurat['tanggal_lahir'])->format('d/m/Y') : '-' }}
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>c. Hubungan</td>
                            <td>:</td>
                            <td>{{ $kontakDarurat['hubungan'] ?? '-' }}</td>
                        </tr>

                        <tr>
                            <td>d. Alamat Tinggal</td>
                            <td>:</td>
                    ...
                    <table class="detail-table" style="margin-left: 14px; width:95%;">
                        <tr>
                            <td width="200">No. Rumah</td>
                            <td width="10">:</td>
                            <td width="150">{{ $kontakDarurat['no_rumah'] ?? '-' }}</td>

                            <td width="100">RT/RW</td>
                            <td width="10">:</td>
                            <td width="150">{{ $kontakDarurat['rt_rw'] ?? '-' }}</td>
                        </tr>

                        <tr>
                            <td width="100">Kelurahan</td>
                            <td width="10">:</td>
                            <td>{{ $kontakDarurat['kelurahan'] ?? '-' }}</td>

                            <td>Kecamatan</td>
                            <td>:</td>
                            <td>{{ $kontakDarurat['kecamatan'] ?? '-' }}</td>
                        </tr>

                        <tr>
                            <td>Kabupaten</td>
                            <td>:</td>
                            <td>{{ $kontakDarurat['kabupaten'] ?? '-' }}</td>

                            <td>Kota</td>
                            <td>:</td>
                            <td>{{ $kontakDarurat['kota'] ?? '-' }}</td>
                        </tr>

                        <tr>
                            <td>Propinsi</td>
                            <td>:</td>
                            <td>{{ $kontakDarurat['provinsi'] ?? '-' }}</td>

                            <td>Kode Pos</td>
                            <td>:</td>
                            <td>{{ $kontakDarurat['kode_pos'] ?? '-' }}</td>
                        </tr>

                        <tr>
                            <td>No. Telp</td>
                            <td>:</td>
                            <td>{{ $kontakDarurat['no_telp'] ?? '-' }}</td>

                            <td>No. HP</td>
                            <td>:</td>
                            <td>{{ $kontakDarurat['no_hp'] ?? '-' }}</td>
                        </tr>
                    </table>

                    <table class="detail-table">
                        <tr>
                            <td width="185">e. Pekerjaan</td>
                            <td width="10">:</td>
                            <td width="350">{{ $kontakDarurat['pekerjaan'] ?? '-' }}</td>

                            <td width="120">Jabatan</td>
                            <td width="10">:</td>
                            <td>{{ $kontakDarurat['jabatan'] ?? '-' }}</td>
                        </tr>
                    </table>
                </div>
            ...
            @if(!empty($saudaraKandung))
                <table class="grid-table">
                    <thead>
                        <tr><th>No</th><th >Nama</th><th >L/P</th><th>Usia</th><th>Pendidikan</th><th>Pekerjaan</th><th>Hubungan</th></tr>
                    </thead>
                    <tbody>
