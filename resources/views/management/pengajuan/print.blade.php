...
<head>
    ...
    <style>
        * {
        ...
        .qr-area {
            height: 75px; /* Disesuaikan agar pas dengan ukuran QR */
            display: flex;
            align-items: center;
            justify-content: center;
        }
        ...
        /* CSS BARU: Gaya teks waktu di bawah QR */
        .qr-time {
            font-size: 11px;
            color: #555;
            margin-bottom: 5px;
            display: block;
            min-height: 14px; /* Menjaga kestabilan tinggi kolom jika waktu kosong */
            vertical-align: top;
        }
...
<div class="print-wrapper">
    <div class="form-cetak">
        ...
        <div class="section">
            ...
            <table class="detail-table">
                <tr><td>{{ $pengajuan->catatan_ptk }}</tr></td>
            </table>
        </div>
        @endif
        ...
        <div class="signature-area">
            ...
            <div class="sign-box">
                ...
                <!-- Waktu dipindahkan ke bawah qr-area dan diberi class baru -->
                <div class="qr-time">
                    @if(isset($qrCodePemohon))
                        {{ $pengajuan->created_at->setTimezone('Asia/Jakarta')->format('d/m/Y H:i') }}
                    @else
                        &nbsp;
                    @endif
                </div>
            ...
            <div class="sign-box dik">
                ...
                <div id="iden" class="flex-container">
                    <div id="iden" class="sub-sign">
                        <div class="qr-area">
                            @if($pengajuan->status == 'disetujui' && isset($qrCodeManager))
                                {!! $qrCodeManager !!}
                            @else
                                &nbsp;
                            @endif
                        </div>
                        <!-- Waktu dipindahkan ke bawah qr-area -->
                        <div class="qr-time">
                            @if($pengajuan->status == 'disetujui' && isset($qrCodeManager))
            ...
            <div class="sign-box {{ $pengajuan->jenis == 'penambahan' ? 'dik' : '' }}">
