...
@push('scripts')
<script>
    // Show/hide fields based on jenis dan atur required secara dinamis
    document.querySelectorAll('input[name="jenis"]').forEach(radio => {
        radio.addEventListener('change', function() {
            ...
            if (this.value === 'penggantian') {
                ...
                // Aktifkan required untuk field penggantian
                filePenggantian.setAttribute('required', 'required');
                inputMenggantikan.setAttribute('required', 'required');
            
                // Matikan required untuk field penambahan & reset nilainya agar bersih
                ...
                // Aktifkan required untuk field penambahan
                filePenambahan.setAttribute('required', 'required');
            
                // Matikan required untuk field penggantian & reset nilainya
